...
export default function Mint(props) {
	...
	const kovanDaiAddress = props.tokenaddr;
	...
	const DoMint = async (tokenURI) => {
		...
		gomint:try{
			...
			let gasLimit = await props.contract.methods.CustomMint(tokenURI,refaddr,0,0).estimateGas(
				{ 
					from: props.address, 
			...
			let result = await props.contract.methods.CustomMint(tokenURI,refaddr,0,0)
				.send({ 
					from: props.address, 
					value: 10000000000000000,
